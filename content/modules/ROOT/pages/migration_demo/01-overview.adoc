...
Make sure that you have enabled the flag *"Deploy RHOSO and VMware Migration Toolkit automatically"* when deploying the catalog item in demo.redhat.com before starting the workshop.
